...
<div className="flex mx-auto max-w-7xl items-center justify-between  px-9 py-3">
 ...
 <h1 onClick={HandleLogoClick} className="text-blue-500 text-[20px] font-bold leading-7 cursor-pointer">
            DevStudio
...
<button onClick={GetStartClicked} className="bg-blue-600 text-white px-4 py-2  rounded font-semibold hover:bg-blue-700">Get Started</button>
